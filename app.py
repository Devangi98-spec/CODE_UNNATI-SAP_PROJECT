...
app.layout =html.Div([
        html.Div([
            ...
            className='start',
            style = {'padding-top' : '1%',"color":"white"}
            ),
            html.Div([
              # stock code input
            ...
            style = {'padding-top':'15 px','padding-bottom':'15 px'}
                     ),
            ...
            html.Div(
              ...
              [
                            dcc.DatePickerRange(
                              ...
                              style = {'font-size': '18px','display': 'inline-block','align':'center', 'border-radius' : '2px', 'border' : '1px solid #ccc', 'color': '#4CAF50', 'border-spacing' : '0', 'border-collapse' :'separate','padding-bottom':' 20px','padding-top': '20px'}
                            ),
              html.Div(id='output-container-date-picker-range',children='')
            ...
            html.Div([
              # Stock price button
              html.Button('Stock Price', id='submit-val', n_clicks=0,style={'float':'left','padding':'15px 32px','background-color':'green','display': 'inline'}),
              html.Div(id='container-button-basic'),
      
            html.Div([
              # Indicators button
              html.Button('Indicator', id='submit-ind', n_clicks=0,style={'float':'left','padding':'15px 32px','background-color':'green','display': 'inline'}),
            ],
                     style = {'padding-top':'15 px','padding-bottom':'15 px'}),
